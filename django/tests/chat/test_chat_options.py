...
def test_chat_options(client, all_apps_user):
    ...
    # Remove translation_glossary if not set (simulate typical form submission)
    if (
        "translation_glossary" in options_form_data
        and not options_form_data["translation_glossary"]
    ):
        del options_form_data["translation_glossary"]
    # Submit the form
