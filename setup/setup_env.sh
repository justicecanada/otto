...
export MGMT_SUBNET_IP_RANGE
export AKS_INGRESS_IP
export JUMPBOX_IP

export BASTION_VNET_NAME
...
export ENTRA_CLIENT_SECRET_EXPIRY
...
jumpbox_identity_id = "${JUMPBOX_IDENTITY_ID}"
