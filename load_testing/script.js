...
export default function () {
  ...
  // let res = http.get(`${base_url}/load_test/?user_library_permissions`); // Heavy Django DB query (takes 40s on local)
  ...
  // let res = http.get(`${base_url}/load_test/?celery_sleep=30`); // Add mock Celery task and see queue lengths
  check(res, {
